...
def crack():
    ...
    os.system(str(MY_WIN_ENV / 'scripts' / 'crack.ps1'))

@setup.command()
def debloat():
    """debloat"""
    from zq.utils.my_win_env import MY_WIN_ENV
    os.system(str(MY_WIN_ENV / 'scripts' / 'debloat.ps1'))

@setup.command()
def defaults():
    """set defaults"""
    from zq.utils.my_win_env import MY_WIN_ENV
    os.system(str(MY_WIN_ENV / 'scripts' / 'setup.ps1'))

@setup.command()
def devenv():
    """setup development environment"""
    from zq.utils.my_win_env import MY_WIN_ENV
    os.system(str(MY_WIN_ENV / 'scripts' / 'devenv.ps1'))
